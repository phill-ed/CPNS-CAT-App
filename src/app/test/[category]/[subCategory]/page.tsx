...
export default function TestPage() {
  ...
  // Parse category and subCategory from params
  ...
  // Filter questions based on category/subCategory
  const testQuestions: Question[] = questions
    .filter(q => {
      if (categoryParam === 'PU' && subCategoryParam) {
        return q.category === 'PU' && q.subSubCategory === subCategoryParam
      }
      return q.category === categoryParam
    })
    .map(q => ({
      id: q.id,
      text: q.text,
      ...
      points: q.points,
      answers: [
        { id: 'a', text: 'Jawaban A', isCorrect: false },
        { id: 'b', text: 'Jawaban B', isCorrect: false },
        { id: 'c', text: 'Jawaban C', isCorrect: false },
        { id: 'd', text: 'Jawaban D', isCorrect: false }
      ]
    }))

  // If no questions found, show sample
  const displayQuestions: Question[] = testQuestions.length > 0 ? testQuestions : [
    {
      id: 'sample-1',
      text: 'Contoh soal untuk ' + categoryParam + (subCategoryParam ? ' - ' + subCategoryParam : ''),
      points: 1,
      answers: [
        { id: 'a', text: 'Pilihan A' },
        { id: 'b', text: 'Pilihan B' },
    ...
    {
      id: 'sample-2',
      text: 'Soal kedua dalam kategori ini',
      points: 1,
      answers: [
        { id: 'a', text: 'Pilihan A' },
        { id: 'b', text: 'Pilihan B' },
  ...
  const testInfo = {
    title: categoryParam + (subCategoryParam ? ' - ' + subCategoryParam : '') + ' Practice',
    duration: 100,
